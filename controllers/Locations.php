...
class Locations extends Secure_area implements Idata_controller
{
	...
	*/
	...
	function does_have_valid_number_of_locations_for_an_additional_location($email)
	{
		...
		$auth_url = (!defined("ENVIRONMENT") or ENVIRONMENT == 'development') ? 'http://netstartposv21staging.com/allowed_stores.php?email='.rawurlencode($email): 'http://amztechnology.com/allowed_stores.php?email='.rawurlencode($email);
