...
class Deliveries extends Secure_area implements Idata_controller
{
	...
	function index($offset=0)
	{
		...
		$data['date_fields'] = array(
			'estimated_delivery_or_pickup_date' => 'Estimated Delivery/Pickup Date',
			'actual_shipping_date' => 'Actual Shipping Date',
			'actual_delivery_or_pickup_date' => 'Actual Delivery/Pickup Date',
	...
	*/
	...
	function calendar($date_field, $year = '', $month='',$week='',$day='')
	{
		...
		if(!in_array($date_field, $date_fields))
		{
