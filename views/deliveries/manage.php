						...
						<form id="config_columns">
							...
							<div class="piluku-dropdown btn-group table_buttons pull-right">
								...
								<ul id="sortable" class="dropdown-menu dropdown-menu-left col-config-dropdown" role="menu">
										<li class="dropdown-header"><?php echo lang('common_column_configuration'); ?> <span class=""></span><a id="reset_to_default" class="pull-right"><span class="ion-refresh"></span> <?php echo lang('common_reset'); ?></a></li>
							...
							<div id="filter_dropdown_widget" class="piluku-dropdown btn-group table_buttons pull-right keepopen">
								...
								<ul id="filter_dropdown" class="dropdown-menu dropdown-menu-left col-config-dropdown" role="menu">
										...
										<li class="dropdown-header no-border filter-header-top">
											<?php echo lang('common_column_filters'); ?> <span class=""></span><a id="reset_filters_to_default" class="pull-right filter_action"><span class="ion-refresh"></span> Reset</a>
										</li>
										
										<span class="panel">
										<li data-toggle="collapse" data-target="#status_container" data-parent="#filter_dropdown" class="dropdown-header filter-header"><i class="expand-collapse-icon glyphicon glyphicon-plus"></i> <?php echo lang('deliveries_status'); ?> :</li>
										...
										<span class="panel">
										<li data-toggle="collapse" data-target="#in_store_pickup" data-parent="#filter_dropdown" class="dropdown-header filter-header"><i class="expand-collapse-icon glyphicon glyphicon-plus"></i> <?php echo lang('deliveries_instore_pickup'); ?> :</li>
										...
										<span class="panel">
										<li data-toggle="collapse" data-target="#shipping_start_container" data-parent="#filter_dropdown" class="dropdown-header filter-header"><i class="expand-collapse-icon glyphicon glyphicon-plus"></i> <?php echo lang('deliveries_shipping_date_start'); ?> :</li>
										<li id="shipping_start_container" class="panel collapse" >											
											<div style="overflow:hidden;">
											    <div class="form-group">
											        <div class="row">
											            <div class="col-md-12">
											                <div id="shipping_start" data-date="<?php echo isset($filters['shipping_start']) ? $filters['shipping_start'] : ''; ?>"></div>
											            </div>
											        </div>
											    </div>
											</div>
										...
										<span class="panel">
										<li data-toggle="collapse" data-target="#shipping_end_container" data-parent="#filter_dropdown" class="dropdown-header filter-header"><i class="expand-collapse-icon glyphicon glyphicon-plus"></i> <?php echo lang('deliveries_shipping_date_end'); ?> :</li>
										<li id="shipping_end_container" class="panel collapse" >
											...
											<div style="overflow:hidden;">
											    <div class="form-group">
											        <div class="row">
											            <div class="col-md-12">
																			<div id="shipping_end" data-date="<?php echo isset($filters['shipping_end']) ? $filters['shipping_end'] : ''; ?>"></div>
											            </div>
											        </div>
											    </div>
											</div>
										...
										<span class="panel">
										<li data-toggle="collapse" data-target="#delivery_start_container" data-parent="#filter_dropdown" class="dropdown-header filter-header"><i class="expand-collapse-icon glyphicon glyphicon-plus"></i> <?php echo lang('deliveries_delivery_date_start'); ?> :</li>
										<li id="delivery_start_container" class="panel collapse">
											<div style="overflow:hidden;">
											    <div class="form-group">
											        <div class="row">
											            <div class="col-md-12">
																			<div id="delivery_start" data-date="<?php echo isset($filters['delivery_start']) ? $filters['delivery_start'] : ''; ?>"></div>
											            </div>
											        </div>
											    </div>
									...
									<span class="panel">
									<li data-toggle="collapse" data-target="#delivery_end_container" data-parent="#filter_dropdown" class="dropdown-header filter-header"><i class="expand-collapse-icon glyphicon glyphicon-plus"></i> <?php echo lang('deliveries_delivery_date_end'); ?> :</li>
									<li id="delivery_end_container" class="collapse">									
										<div style="overflow:hidden;">
										    <div class="form-group">
										        <div class="row">
										            <div class="col-md-12">
																		<div id="delivery_end" data-date="<?php echo isset($filters['delivery_end']) ? $filters['delivery_end'] : ''; ?>"></div>
																</div>
										        </div>
										    </div>
										</div>
