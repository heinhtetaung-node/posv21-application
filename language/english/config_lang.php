...
$lang['config_confirm_reset_ecom'] = 'Are you sure you want to reset e-commerce? This will only reset Netstart POS B2B so items are no longer linked';
