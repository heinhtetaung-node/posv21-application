...
$lang['migrate_message'] = 'Kami telah mendeteksi bahwa PHP Point Of Database Sale ini perlu ditingkatkan. Klik tombol database Peningkatan bawah untuk memulai proses. Setelah proses selesai, Anda dapat login ke Netstart POS B2B';
...
$lang['migrate_setup_phppos'] = 'Instal Netstart POS B2B';
$lang['migrate_install_message'] = 'Selamat Datang di Netstart POS B2B! Klik tombol di bawah untuk menginstal database Anda! Proses ini dapat berlangsung beberapa menit. Setelah proses selesai Anda dapat login ke POS baru Anda!';
