...
class Inventory_summary extends Report
{
	...
	public function getData()
	{
		...
		$this->db->select('location_id as location_id_outer, items.item_id, items.name, categories.id as category_id,categories.name as category,location, company_name, item_number,size, product_id, '.$this->db->dbprefix('items').'.replenish_level,
